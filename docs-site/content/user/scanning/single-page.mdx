...
![Single page scan form with URL input](/screenshots/scan-form-filled.png)
...
Once complete, you'll see the full results with your accessibility score, AI summary, and issue breakdown.

![Completed scan results page](/screenshots/scan-results.png)
